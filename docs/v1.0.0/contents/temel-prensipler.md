...
| 422  Unprocessable Entity | **3.17 Idempotency Kuralları bölümünde örneklenen hata durumu için kullanılır.**|  |  |  |
...
errorCode: "TR.OBHS.Resource.Forbidden"
...
errorCode: "TR.OBHS.Resource.NotFound"
...
errorCode: "TR.OBHS.Resource.MethodNotAllowed"
...
errorCode: " TR.OBHS.Resource.NotAcceptable"
...
errorCode: " TR.OBHS.Resource.UnsupportedMediaType"
moreInformation: “Content type not supported”
moreInformationTr: “Desteklenmeyen içerik tipi” 
```
<ins>**422  Unprocessable Entity**</ins>
```json 
httpCode: 422,
httpMessage: "Unprocessable Entity",
moreInformation: "Gönderilen istek başlığı x-request-id değeri ile veri gövdesi sağlama toplamı önceki veri ile uyuşmuyor",
moreInformationTr: "x-request-id header and request checksum does not match with previously sent payload.",
errorCode: "TR.OBHS.Business.InvalidContent"
```
...
errorCode: " TR.OBHS.Connection.ExceededRate"
...
errorCode: "TR.OBHS.Server.InternalError"
...
errorCode: "TR.OBHS.Server.ServiceUnavailable "
